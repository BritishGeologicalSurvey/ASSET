...
def main():
    ...
    def convert_to_arl(gribfile,arlfile):
        os.system('salloc -n 1 /home/vulcanomod/HYSPLIT/hysplit.v4.2.0/exec/api2arl_v4 -d/home/vulcanomod/Operational_modelling/weather/scripts/api2arl.cfg -i' + gribfile + ' -o' + arlfile) 
